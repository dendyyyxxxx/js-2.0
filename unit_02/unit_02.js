...
let e = 3;
let f = 5;
document.querySelector(".out-3").textContent = f+e
...
// которая выводит в div.out-8 то, что пользователь ввел в input.i-8.
// const f1 = (a, b) => {
// return a + b
// }
// function g(a, b) {
...
// (вы же включили отображение пробелов?). Вы не добавляете "от себя" - запятые,
// любые другие слова и символы. Аналогичные правила действуют и дальше по курсу.
const t12 = () => {
